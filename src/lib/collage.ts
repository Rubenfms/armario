...
const SLOTS: Record<Exclude<Category, 'accesorio'>, Box> = {
...
const ACCESSORY_SLOTS: readonly Box[] = [
  [0.8, 0.04, 0.18, 0.15],
  [0.8, 0.21, 0.18, 0.15],
  [0.8, 0.38, 0.18, 0.15],
  [0.8, 0.55, 0.18, 0.15],
...
const DRAW_ORDER: readonly Category[] = ['abrigo', 'inferior', 'superior', 'calzado', 'accesorio'];
